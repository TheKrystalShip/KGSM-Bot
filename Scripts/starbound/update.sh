...
download_version() {
    ...
    # Download new version in temp folder
    download_exit_code=$(steamcmd +@sSteamCmdForcePlatformType linux +force_install_dir "$TEMP_DOWNLOAD_FOLDER" +login "$USER" "$PASSWORD" +app_update "$APP_ID" -beta none validate +quit)

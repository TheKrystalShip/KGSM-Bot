...
download_version() {
    ...
    # Download new version in temp folder
    download_exit_code=$(steamcmd +@sSteamCmdForcePlatformType linux +force_install_dir "$TEMP_DOWNLOAD_FOLDER" +login anonymous +app_update 1007 validate +app_update "$APP_ID" validate +quit)
